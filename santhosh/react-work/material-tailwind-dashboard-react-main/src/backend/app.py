...
# API route to generate course content
@app.route('/generate_course', methods=['POST'])
def generate_course():
    data = request.json  # Receive JSON data from React frontend
    ...
    course_data = response.text  # AI-generated course content

    # Build chapters with YouTube videos
    chapters = []
