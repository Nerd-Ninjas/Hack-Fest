...
const HeroSection = () => {
  return (
    <>
        <div className="hero-section-content flex justify-center gap-5 text-white ">
            <div className="hero-section-con mt-20">
            <p className='font-medium text-zinc-300'>Learning Excellence</p>
            <h2 className='mt-5 text-5xl text-white p-1 mb-10 font-bold'>
            ...
            <div className="hero-section-action-btn mt-10">
                <button className='text-xl font-bold'>Get Started</button>
            </div>
            </div>
          
            <div className="hero-section-img w-full mt-20">
