...
export const dialogueData = {
  ...
  Multiplication (*): The multiplication operator repeats a string or multiplies two numbers. For example, 3 * 'A' gives you 'AAA', repeating the letter A three times.<a href="https://youtu.be/GEMZpw7ug-k?si=CbT2nEqcfLRdq8AE" target="_blank">Learn More</a>`,
  ...
  Repeating a String (*): You can repeat a string multiple times by using the * operator. For example, 3 * 'A' will give you 'AAA'.<a href="https://youtu.be/k_5Q_dHSMCw?si=nN7nW1jaI6zNnu_2" target="_blank">Learn More</a>`,
  ...
  List Conversion (list(range())): The list() function converts the range of numbers into a list format. For example, list(range(3)) will give [0, 1, 2], which is a list.<a href="https://youtu.be/rmaaKvh94Vs?si=-FIVnMdbcyuD0EcH" target="_blank">Learn More</a>`,
  ...
  Type Conversion (int() or str()): You can convert one data type to another. For instance, if you have a string '10', you can convert it to an integer by using int('10'), which gives 10.<a href="https://youtu.be/ejsWWaLZrrM?si=YMrKLOK3uRuhIhba" target="_blank">Learn More</a>`,
  ...
  Empty List as False (bool([])): In Python, an empty list is considered False in a boolean context. For example, bool([]) will return False because an empty list is "falsy" in Python.<a href="https://youtu.be/1oXjj975oDQ?si=Q_N_zg4RhdSAS9Vj" target="_blank">Learn More</a>`,
  ...
  Get Method (get()): The get() method allows you to fetch a value from a dictionary using its key. If the key doesn’t exist, it will return a default value. For example, {'a': 1}.get('b', 0) will return 0 because 'b' isn’t a key in the dictionary. <a href="https://youtu.be/Hea64Ey_gVU?si=Mxkm2BV9bYrWuGx-" target="_blank">Learn More</a>`,
  ...
  Sum (sum()): The sum() function adds up all the numbers in a list. For example, sum([1, 2, 3]) gives 6, which is the sum of 1, 2, and 3. <a href="https://youtu.be/gktjNyV0xks?si=jmQhhamzD0i255g8" target="_blank">Learn More</a>`,
  ...
  exit: `Check your knowledge <a href="https://www.youtube.com/@ThePrimeTimeagen" target="_blank">Take Test!!</a>`,
};
